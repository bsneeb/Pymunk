...
# Calculate angle in radians between two points, assuming p2 is [0,0]
...
# Add object to screen and watch it interact with the space
...
# Add structures to fire the ball at
...
# Make a main event loop 
def run(window, width, height):
    run = True
    clock = pygame.time.Clock()
    fps = 60
    dt = 1 / fps    # dt = delta time

    # Create space
    space = pymunk.Space()
    space.gravity = (0, 981)   # Simulate gravity

    # Make some objects and boundry
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Once it is created, launch on click
                elif pressed_pos:
                ...
                # If ball just launched, delete the ball
                else:
